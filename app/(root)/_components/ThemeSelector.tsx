...
const THEME_ICONS: Record<string, React.ReactNode> = {
  ...
  "github-dark": <IoLogoGithub className="size-4" />,
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className={`w-48 group relative flex items-center gap-2 px-4 py-1.5 bg-light/80 hover:bg-[#262637] 
      ...
      >
        ...
        <span className="text-gray-300 min-w-[80px] text-left group-hover:text-white transition-colors text-sm font-medium">
          {currentTheme?.label}
        </span>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`absolute top-full left-0 mt-2 w-full min-w-[240px] bg-light/95 
