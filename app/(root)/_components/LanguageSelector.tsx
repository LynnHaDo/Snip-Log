  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <div className="w-4 h-4 rounded-md bg-gray-800/50 p-0.5 group-hover:scale-110 transition-transform">
          <Image
        ...
        <span className="text-gray-200 min-w-[80px] text-left group-hover:text-white transition-colors text-sm font-medium">
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <div className="max-h-[280px] overflow-y-auto overflow-x-hidden text-sm font-medium">
              {Object.values(LANGUAGES_CONFIGS).map((lang, index) => {
                const isLocked = !props.hasAccess && lang.id !== DEFAULT_LANGUAGE;
