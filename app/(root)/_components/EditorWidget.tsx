...
import IStandaloneCodeEditor, { Editor, EditorProps, Monaco } from "@monaco-editor/react";
...
export default function EditorWidget() {
  ...
  const { configs, setFontSize } = useCodeEditorStore();
  ...
  const handleFontSizeChange = (newSize: number) => {
    ...
    setFontSize(size);
    localStorage.setItem(DEFAULT_EDITOR_FONT_SIZE_KEY, size.toString());
  };
